...
def calculate_metrics():
    ...
    for date in all_dates:
        ...
        # Track Total System Storage (End of Day)
        current_total_storage = sum(stp_storage.values())

        # Daily Aggregates for Dashboard
        # Need: Date, NetScore, GainOffset, GainSOC, CostTransport, CostLeach, CostOverflow, 
        #       DeliveredTons, DeliveredN, DemandN (System), RoundTripKM, MonsoonTons, StorageLevel
        ...
        daily_stats.append({
            ...
            'total_storage_tons': current_total_storage
        })
